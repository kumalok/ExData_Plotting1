...
par(mfcol=c(2,2))
plot(data_temp$DateTime, data_temp$Global_active_power,type="l",   ylab= "Global Active Power", xlab="")
...
plot(data_temp$DateTime,data_temp$Voltage, type="l",  ylab="Voltage",xlab="datetime")
plot(data_temp$DateTime,data_temp$Global_reactive_power, type="l",  xlab="datetime",ylab="Global_reactive_power")
dev.off()
